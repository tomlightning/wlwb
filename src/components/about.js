    ...
    return (
        <div className="container">
            ...
            <div className="row mw-640px"> 
                ...
                <p className="text-success"> <img src="../images/twitter.svg"/> Follow us in Twitter (@e_steroids) to get more dWebsites new</p>

                <p  className="text-success">✉️ write us in contact@esteroids.xyz.</p>
            </div>
        </div>
    )
